                                    ...
                                    <div class="col-lg-6 accordion" id="myAccordion">
                                        ...
                                        <div class="accordion-item mb-3 rounded-0">
                                            <h2 class="accordion-header shadow-sm" id="headingThree">
                                                <button type="button"
                                                    class="accordion-button trigger_title collapsed rounded-0"
                                                    ...
                                                    <div class="row">
                                                        <div class="mb-1 col-md-6">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                id="name" name="name" placeholder="E.g : MD Rassel"
                                                                required>
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            ...
                                                            <input type="email"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="email" name="email"
                                                                placeholder="E.g : russel@gmail.com" required>
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                            <div class="invalid-feedback">
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="address" name="address" placeholder="E.g : Dhaka"
                                                                required>
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="district" name="district" placeholder="E.g : Dhaka"
                                                                required>
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="country" name="country" placeholder="E.g : Dhaka"
                                                                required>
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                        ...
                                        <div class="accordion-item mb-3 rounded-0">
                                            <h2 class="accordion-header shadow-sm" id="headingThree">
                                                <button type="button"
                                                    ...
                                                    data-bs-target="#personal-details">Professional
                                                    Training</button>
                                            </h2>
                                            ...
                                            <div id="personal-details" class="accordion-collapse collapse"
                                                ...
                                                <div class="card-body shadow-sm p-3">
                                                    <div class="row">
                                                        <div class="mb-1 col-md-6">
                                                            <label for="training_one_institution"
                                                                class="fw-light">Training-One
                                                                Institution Name</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="training_one_institution"
                                                                name="training_one_institution"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="training_two_institution"
                                                                class="fw-light">Training-Two
                                                                Institution Name</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="training_two_institution"
                                                                name="training_two_institution"
                                                                placeholder="E.g : Training With">
                                                        </div>
                                                        <div class="mb-1 col-md-6">
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="training_three_institution"
                                                                class="fw-light">Training-Three
                                                                Institution Name</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="training_three_institution"
                                                                name="training_three_institution"
                                                                placeholder="E.g : Training With">
                                                        </div>
                                                        <div class="mb-1 col-md-6">
                                                            <label for="training_three_topic"
                                                                class="fw-light">Training-Three
                                                                Topic</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                        ...
                                        <div class="accordion-item mb-3 rounded-0">
                                            <h2 class="accordion-header shadow-sm" id="headingThree">
                                                <button type="button"
                                                    class="accordion-button trigger_title collapsed rounded-0"
                                                    data-bs-toggle="collapse"
                                                    data-bs-target="#professional-details">Professional
                                                    Details</button>
                                            </h2>
                                                ...
                                                <div class="card-body shadow-sm p-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="professional_depertment_one"
                                                                name="professional_depertment_one"
                                                                placeholder="E.g: Web Development">
                                                        </div>
                                                        <div class="mb-1 col-md-6">
                                                            ...
                                                            <input type="date"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="professional_start_date_one"
                                                                name="professional_start_date_one"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            ...
                                                            <input type="date"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="professional_end_date_one"
                                                                name="professional_end_date_one"
                                                                placeholder="E.g: 10/05/2023">
                                                        </div>
                                                        <div class="mb-1 col-md-6">
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="professional_depertment_two"
                                                                name="professional_depertment_two"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            ...
                                                            <input type="date"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="professional_start_date_two"
                                                                name="professional_start_date_two"
                                                                placeholder="E.g: 10/05/2023">
                                                        </div>
                                                        <div class="mb-1 col-md-6">
                                                            ...
                                                            <input type="date"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="professional_end_date_two"
                                                                name="professional_end_date_two"
                                                                placeholder="E.g: 10/05/2023">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="accordion-item mb-3 rounded-0">
                                            <h2 class="accordion-header shadow-sm" id="headingThree">
                                                <button type="button"
                                                    class="accordion-button trigger_title collapsed rounded-0"
                                                    data-bs-toggle="collapse"
                                                    data-bs-target="#professional-details">Academic
                                                    Details</button>
                                            </h2>
                                            <div id="professional-details" class="accordion-collapse collapse">
                                                <div class="card-body shadow-sm p-3">
                                                    <div class="row">
                                                        <div class="mb-1 col-md-6">
                                                            <label for="academic_institution_one" class="fw-light">
                                                                Institution Name-One <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="academic_institution_one"
                                                                name="academic_institution_one"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="academic_degree_one" class="fw-light"> Degree
                                                                Name-One <span class="text-danger">*</span></label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="academic_passing_one" class="fw-light">Passing
                                                                Year-One <span class="text-danger">*</span></label>
                                                            <input type="date"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="academic_result_one" class="fw-light">Result-One
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="academic_institution_two"
                                                                name="academic_institution_two"
                                    ...
                                    <div class="col-lg-6 accordion" id="myAccordion">
                                        ...
                                        <div class="accordion-item mb-3 rounded-0">
                                            <h2 class="accordion-header shadow-sm" id="headingThree">
                                                <button type="button"
                                                    class="accordion-button trigger_title collapsed rounded-0"
                                                    data-bs-toggle="collapse" data-bs-target="#skill-set">Skill
                                                    Set</button>
                                            </h2>
                                            <div id="skill-set" class="accordion-collapse collapse">
                                                <div class="card-body shadow-sm p-3">
                                                    <div class="row">
                                                        <div class="mb-1 col-md-6">
                                                            <label for="skill_one" class="fw-light">Skill-One
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="skill_one" name="skill_one"
                                                                placeholder="E.g : Ms Word, React">
                                                        </div>
                                                        <div class="mb-1 col-md-6">
                                                            <label for="skill_two" class="fw-light">Skill-Two
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="skill_two" name="skill_two"
                                                                placeholder="E.g : Ms Execl, Python">
                                                        </div>
                                                        <div class="mb-1 col-md-6">
                                                            <label for="skill_three" class="fw-light">Skill-Three
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="skill_four" class="fw-light">Skill-Four
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="skill_four" name="skill_four"
                                                                placeholder="E.g : Ms Outlook, Php">
                                                        </div>
                                                        <div class="mb-1 col-md-6">
                                                            <label for="skill_five" class="fw-light">Skill-Five
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="skill_five" name="skill_five"
                                                                placeholder="E.g : Photoshop, Laravel">
                                                        </div>
                                                        <div class="mb-1 col-md-6">
                                                            <label for="skill_six" class="fw-light">Skill-Six
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                                id="skill_six" name="skill_six"
                                                                placeholder="E.g : Illustrator, Ruby">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="accordion-item mb-3 rounded-0">
                                            ...
                                            <div id="skill-set" class="accordion-collapse collapse">
                                                <div class="card-body shadow-sm p-3">
                                                    <div class="row">
                                                        <div class="mb-1 col-md-6">
                                                            <label for="activity_one" class="fw-light">Activity-One
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="activity_two" class="fw-light">Activity-Two
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="activity_three" class="fw-light">Activity-Three
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="activity_four" class="fw-light">Activity-Four
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="activity_five" class="fw-light">Activity-Five
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="activity_six" class="fw-light"> Activity-Six
                                                                Title</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                        ...
                                        <div class="accordion-item mb-3 rounded-0">
                                            <h2 class="accordion-header shadow-sm" id="headingThree">
                                                <button type="button"
                                                    class="accordion-button trigger_title collapsed rounded-0"
                                                    data-bs-toggle="collapse"
                                                    data-bs-target="#reference-relative">Reference
                                                    Relative</button>
                                            </h2>
                                            <div id="reference-relative" class="accordion-collapse collapse">
                                                <div class="card-body shadow-sm p-3">
                                                    <div class="row">
                                                        <div class="mb-1 col-md-6">
                                                            <label for="reference_name_one" class="fw-light">Reference
                                                                Name-One <span class="text-danger">*</span></label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="reference_organisation_one"
                                                                class="fw-light">Reference
                                                                Organisation Name-One <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="reference_email_one" class="fw-light">Reference
                                                                Email-One
                                                                <span class="text-danger">*</span></label>
                                                            <input type="email"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="reference_phone_one" class="fw-light">Reference
                                                                Phone-One
                                                                <span class="text-danger">*</span></label>
                                                            <input type="number"
                                                                class="form-control form-control-sm border-0 bg-light"
                                        ...
                                        <div class="accordion-item mb-3 rounded-0">
                                            ...
                                            <div id="reference-relative" class="accordion-collapse collapse">
                                                <div class="card-body shadow-sm p-3">
                                                    <div class="row">
                                                        <div class="mb-1 col-md-6">
                                                            <label for="reference_name_two" class="fw-light">Reference
                                                                Name
                                                                -Two</label>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 bg-light"
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="reference_organisation_two"
                                                                class="fw-light">Reference
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            <label for="reference_phone_two" class="fw-light">Reference
                                                                Phone
                                                                -Two</label>
                                                            <input type="number"
                                                                class="form-control form-control-sm border-0 bg-light"
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="file" class="form-control form-control-sm bg-light"
                                                        id="resume" name="resume" placeholder="Your Upload Your CV"
                                                        required>
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
