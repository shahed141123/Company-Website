            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-sm-12 p-0">
                    <div class="d-flex justify-content-center align-items-center"
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            <form class="login-form needs-validation" method="POST" action="{{ route('admin.password.store') }}"
                                ...
                                <div class="card mb-0 admin-login-form">
                                    <div class="card-body">
                                        <div class="text-center mb-3">
                                            ...
                                            <p class="mb-0 text-muted">Reset Password to Login to your admin account.</p>
                                        </div>
                                        ...
                                        <div class="text-center mb-3 pt-3">
                                            ...
                                            <button type="submit" class="btn w-md-100 w-100 mt-3"
                                                style="background:#ae0a46;border-radius: 0px;color: white;border: none;">Reset Your Password</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
