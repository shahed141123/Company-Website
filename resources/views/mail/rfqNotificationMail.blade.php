        ...
        <td>
          ...
          <section style="margin-top: 0rem; margin-bottom: 0rem; box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;">
            ...
            <div class="wrapper" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;">
              ...
              <!-- Main Content Start -->
              <div style="overflow-x: auto">
                <table id="u_body" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;vertical-align: top;min-width: 320px;margin: 0 auto;width: 100%;"
                    cellpadding="0" cellspacing="0">
                    <tbody style="min-width: 320px">
                        <tr>
                            <div style="text-align: left;padding: 15px;">
                                <h4 style="text-align: left; font-size: 18px; color: #141414;">Dear {{$data['name']}}</h4>
                            </div>
                        </tr>
                        <tr>
                            <div style="text-align: left;padding: 15px;">
            ...
            <div style="overflow-x: auto">
                <table id="u_body"
                    ...
                    <tbody style="min-width: 320px">
                        ...
                        {{-- <tr>
                            <th
                                style="border-bottom:1px solid #e7e7e7;background-color:#f1f1f1;padding:10px 15px;font-size:12px;text-align:left">
