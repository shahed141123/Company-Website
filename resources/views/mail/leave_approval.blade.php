                ...
                <tr>
                    @if ($data['status'] == 'substitute_approval_pending')
                        <td
                            ...
                            Hope, you are doing well. I am applying for a leave from {{ $data['leave_start_date'] }} to
...
@endif -->
                ...
                <tr>
                    <td style="padding:25px 20px 10px; text-align: left;font-size:15px">
                        I would be grateful if you can approve my leave request for the aforementioned period. Hoping to
