...
@section('content')
        ...
        <div class="content">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-12 py-2" style="background-color: rgb(74, 166, 206); color:white;">
                            <h5 class="text-center mb-0">All RFQs</h5>
                        </div>
                            ...
                            <table class="table table-bordered table-hover">
                                <thead>
                                    <tr class="text-center" style="background: rgb(221, 220, 220);">
                                        <td width="10%">Id</td>
                                        <td width="15%">Rfq Code</td>
                                        <td width="40%">Product Name</td>
                                        <td width="15%">Rfq Status</td>
                                        <td class="text-center" width="20%">Work order</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    @if ($rfqs)
                                        @foreach ($rfqs as $key => $rfq)
                                            <tr>
                                                ...
                                                <td class="text-center" width="10%"> {{ $deal_sas->tax }}%</td>
                                                <td class="text-center" width="10%"> $ {{ $deal_sas->tax_sales }}</td>
                                            </tr>
    ...
    <!---Category Update modal--->
    <a href="javascript:void(0);" class="text-primary mx-2" data-bs-toggle="modal" title="Upload Proof of Payment"
                                            ...
                                            @foreach ($deal_products as $key => $item)
                                                <tr>
                                                    ...
                                                    @if ($rfq->regular == '1')
                                                        ...
                                                        <th width="10%" class="rg_discount d-none">
                                                            {{ number_format($item->sales_price / $item->qty, 2) }}</th>
                                                    @else
                                        ...
                                        <table class="table table-bordered"
                                            ...
                                            <thead>
                                                <tr class="border-none">
                                                    <th class="border-none" colspan="3"
                                                        style="background: offset; width:60%; margin:auto;">
                                                        <label for="clientPO" style="font-size:16px;">Payment Slip
                                                            (Pdf)
                                                        </label>
