                ...
                <div class="forms">
                    <div class="form-content">
                        <div class="login-form">
                            ...
                            <form action="{{ route('client.loginstore') }}" method="POST">
                                ...
                                <div class="input-boxes">
                                    ...
                                    @enderror
                                    <div class="input-box">
                                        <i class="fas fa-eye viewPassword"></i>
                        ...
                        <div class="signup-form">
                            <div class="title">Partner Signup</div>
                                ...
                                <div class="input-boxes">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <input type="password" name="password_confirmation"
                                            value="{{ old('password_confirmation') }}" placeholder="Re Enter your password"
                                            required>
                                    </div>
...
@section('scripts')
    <script>
        $('.viewPassword').on('click', function() {
            let input = $(this).next("input[name='password']");
