                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div id="table1" class="card cardTd">
                                ...
                                <div class="card-body">
                                    <form method="post" action="{{ route('convert.deal', $rfq->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="accordion padding" id="accordion_expanded">
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#sales_manager">
                                                        <i class="fas fa-plus-square me-3 fa-1x"></i> Assigned Sales Manager


                                                    </button>
                                                </h2>
                                                <div id="sales_manager" class="accordion-collapse collapse show" data-bs-parent="#accordion_expanded">
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="form-group text-secondary col-sm-8">
                                                                    <select name="sales_man_id_L1" class="form-control select"
                                                                        ...
                                                                        @foreach ($users as $user)
                                                                            <option value="{{ $user->id }}" {{ $rfq->sales_man_id_L1 == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 mb-3">
                                                                ...
                                                                <div class="form-group text-secondary col-sm-8">
                                                                    <select name="sales_man_id_T1" class="form-control select"
                                                                        ...
                                                                        <option></option>
                                                                        @foreach ($users as $user)
                                                                            <option value="{{ $user->id }}" {{ $rfq->sales_man_id_T1 == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-3 mb-3">
                                                                ...
                                                                <div class="form-group text-secondary col-sm-8">
                                                                    <select name="sales_man_id_T2" class="form-control select"
                                                                        ...
                                                                        <option></option>
                                                                        @foreach ($users as $user)
                                                                            <option value="{{ $user->id }}" {{ $rfq->sales_man_id_T2 == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-3 mb-3">
                                                                ...
                                                                <div class="form-group col-sm-8 text-secondary">
                                                                    <input type="date" name="close_date" class="form-control" value="{{ $rfq->close_date }}"/>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#client_details">
                                                        <i class="fas fa-plus-square me-3 fa-1x"></i> Client Details


                                                    </button>
                                                </h2>
                                                <div id="client_details" class="accordion-collapse collapse show" data-bs-parent="#accordion_expanded">
                                                    <div class="accordion-body">

                                                        <div class="row mb-3 p-2 border">
                                                            <div class="col-lg-4 mb-3">
                                                                <div class="col-sm-8">
                                                                    <p class="mb-0">Client Type <span class="text-danger">*</span></p>
                                                                </div>
                                                                <div class="form-group text-secondary col-sm-8">
                                                                    <select name="client_type" class="form-control select client_select"
                                                                        ...
                                                                        <option></option>
                                                                        <option class="form-select" value="client" {{ $rfq->client_type == 'client' ? 'selected' : '' }}>
                                                                            Client
                                                                        </option>
                                                                        <option class="form-select" value="partner" {{ $rfq->client_type == 'partner' ? 'selected' : '' }}>
                                                                            Partner</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="form-group text-secondary col-sm-8 basic-form">
                                                                    <select name="client_id" class="form-control select clientID"
                                                                        ...
                                                                        @foreach ($clients as $client)
                                                                            <option value="{{ $client->id }}" {{ $rfq->client_id == $client->id ? 'selected' : '' }}>
                                                                                Name : {{ $client->name }}; Company Name : {{ $client->company_name }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-4 mb-3 partner_display d-none">
                                                                ...
                                                                <div class="form-group text-secondary col-sm-8">
                                                                    <select name="partner_id" class="form-control select partnerID"
                                                                        ...
                                                                        @foreach ($partners as $partner)
                                                                            <option value="{{ $partner->id }}" {{ $rfq->partner_id == $partner->id ? 'selected' : '' }}>
                                                                                Name : {{ $partner->name }}; Company Name : {{ $partner->company_name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                                             <div class="col-lg-4 mt-3 partner_account d-none text-warning">
                                                                <div class="form-check">
                                                                    <input class="form-check-input account" type="checkbox" value="partner" name="account" id="flexCheckDefault">
                                                            ...
                                                            <div class="col-lg-4 mt-3 client_account d-none text-warning">
                                                                <div class="form-check">
                                                                    <input class="form-check-input account" type="checkbox" value="client" name="account" id="flexCheckDefault">
                                                                    <label class="form-check-label" for="flexCheckDefault">
                                                        ...
                                                        <div class="center mb-3 bg-gray p-1 text-center">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox" value="1" name="regular" id="flexRadioDefault1" {{ $rfq->regular == '1' ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="flexRadioDefault1">
                                                                    Regular Discount
                                                                </label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox" value="1" name="special" id="flexRadioDefault2" {{ $rfq->special == '1' ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="flexRadioDefault2">
                                                                    Special Discount
                                                                </label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox" value="1" name="tax_status" id="flexRadioDefault3" {{ $rfq->tax_status == '1' ? 'checked' : '' }}>
                                                            ...
                                                            <div class="col-lg-2 mb-3">
                                                                ...
                                                                <div class="form-group col-sm-12 text-secondary">
                                                                    <input type="text" name="phone" class="form-control maxlength"
                                                                        maxlength="100" required value="{{ $rfq->phone }}"/>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-2 mb-3">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="form-group col-sm-12 text-secondary">
                                                                    <input type="text" name="company_name" class="form-control maxlength"
                                                                        maxlength="200" value="{{ $rfq->company_name }}"/>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-2 mb-3">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="form-group col-sm-12 text-secondary">
                                                                    <input type="text" name="designation" class="form-control maxlength"
                                                                        maxlength="100" value="{{ $rfq->designation }}"/>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-2 mb-3">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="form-group col-sm-12 text-secondary">
                                                                    <input type="text" name="address" class="form-control maxlength"
                                                                        maxlength="200" value="{{ $rfq->address }}"/>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#add_product">
                                                        <i class="fas fa-plus-square me-3 fa-1x"></i> Product Details
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="table-responsive m-auto" style="width: 80%">
                                                            <table class="table table-bordered text-center">
                                                                ...
                                                                @php
                                                                    $product = App\Models\Admin\Product::where('id', $rfq->product_id)->first();
                                                                @endphp
                                                        ...
                                                        <table class="table table-bordered table-striped">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <td width="22%">
                                                                        <input type="text" name="validity" class="form-control maxlength" maxlength="200"
                                                                        value="7 Days from the PQ date.Offer may change on the bank forex rate or stock availability"/>
                                                                    </td>
                                                                    <th width="10%">Payment </th>
                                                                    <td width="22%">
                                                                        <input type="text" name="payment" class="form-control maxlength" maxlength="200"
                                                                    ...
                                                                    <td width="22%">
                                                                        ...
                                                                        maxlength="200" value="Payment must be through Cheque/EFTN/WT & hit in the NGen IT account"/>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="22%">
                                                                        <input type="text" name="delivery" class="form-control maxlength" maxlength="200"
                                                                    ...
                                                                    <td width="22%">
                                                                        ...
                                                                        maxlength="200" value="Automatice Renewal Activation to the Licenses & Client's Console Panel"/>
                                                                    </td>
                                                                    <th width="10%">Product & Order </th>
                                                                    <td width="22%">
                                                                        <input type="text" name="product_order" class="form-control maxlength"
                                                                        maxlength="200" value="May reject/modify order on any dispute in pr. price or product non-availability during execuation"/>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="22%">
                                                                        ...
                                                                        maxlength="200" value="Not Applicable. Local Support is Not Included with this Cost as per requirements"/>
                                                                    </td>
                                                                    <th width="10%">Pmt Condition </th>
                                                                    <td width="22%">
                                                                        <input type="text" name="pmt_condition" class="form-control maxlength"
                                                                        maxlength="200" value="1.5% penalty per week on late from 7 days of / Payment Date"/>
                                                                    </td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 text-center">
                                                <button class="btn btn-primary px-2 mt-5" name="action" type="submit" id="submitbtn">
                                                    Send For Price
