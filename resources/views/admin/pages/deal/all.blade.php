                            ...
                            <ul class="nav nav-tabs mx-auto d-flex justify-content-center"
                                ...
                                <li class="nav-item mb-0">
                                    <a href="#js-tab1" class="p-1 nav-link active cat-tab1" data-bs-toggle="tab">
                                        <p class="text-white"
                                            style="font-size: 12px; font-weight:600;margin-bottom:0px;padding:5px;">
                                            Deal Created</p>
                                    </a>
                                </li>

                                <li class="nav-item mb-0 ml-1">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="js-tab1">
                                <div id="table1" class="card-body">
                                    <table class="rfqDT1 table table-bordered table-hover text-center">
                                        <thead>
                                            <tr>
                                                <th>Id</th>
                                                <th>RFQ Code</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a href="{{ route('deal-sas.show', $rfq->rfq_code) }}"
                                                                ...
                                                                <i class="ph-file-plus dash-icons"></i>
                                                            </a>
                                                            <a href="javascript:void(0);" class="text-info mx-2 me-0" title="Show Deal"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#update_category_{{ $rfq->rfq_code }}">
                                                                <i class="icon-eye dash-icons"></i>
                                                            </a>
                                                            <a href="{{ route('deal.destroy', [$rfq->id]) }}"
                                                                class="text-danger delete mx-2 me-0">
                                                ...
                                                @foreach ($deals as $key => $deal)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a href="javascript:void(0);" class="text-info mx-2 me-0"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade" id="js-tab3">
                                <div id="table3" class="card-body">
                                    <table class="rfqDT3 table table-bordered table-hover text-center">
                                        <thead>
                                            <tr>
                                                <th>Id</th>
                                                <th>RFQ Code</th>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade" id="js-tab4">
                                <div id="table4" class="card-body">
                                    <table class="rfqDT4 table table-bordered table-hover text-center">
                                        <thead>
                                            <tr>
                                                <th>Id</th>
                                                <th>RFQ Code</th>
