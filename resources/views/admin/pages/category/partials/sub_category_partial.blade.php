                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('subcategory.destroy', [$sub_cat->id]) }}"
                                        ...
                                        <i
                                            class="fa-solid fa-trash dash-icons text-danger"></i>
                                    </a>
                                </td>
                            </tr>
                        @endforeach
