<div class="tab-pane fade show" id="sub_sub_category">
    <div class="d-flex align-items-center">
        {{-- Add Category Modal --}}
        <a href="" class=" text-success nav-link cat-tab3" data-bs-toggle="modal" data-bs-target="#subsubcategoryAdd"
            ...
            <div class="d-flex justify-content-between">
                <span class="ms-1">Add Sub Sub Category</span>
            </div>
            <div class="d-flex justify-content-between hide_mobile">
                <h6 class="mb-0 text-black text-center" style="margin-left: 17rem !important;">
                    Sub Sub Category</h6>
            </div>
        </a>
    </div>
