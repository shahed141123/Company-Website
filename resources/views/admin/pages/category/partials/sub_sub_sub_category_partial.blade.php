<div class="tab-pane fade" id="sub_sub_sub_category">
    <div class="row">
        <div class="col-lg-12">
            <div class="d-flex justify-content-between align-items-center py-1 px-4 mt-3 rounded-1"
                style="background-color: #247297">
                <div>
                    <h5 class="mb-0 text-white">Sub Sub Sub Category Management</h5>
                </div>
                <div>
                    <a href="" data-bs-toggle="modal" data-bs-target="#subsubsubcategoryAdd">
                        <div class="d-flex align-items-center">
                            <span class="ms-2 icon_btn" style="font-weight: 800;" data-bs-toggle="tooltip"
                                data-bs-placement="top" title="Add Category">
                                <i class="ph-plus text-white"></i> </span>
                            <span class="ms-1 text-white">Add Sub Sub Sub Category</span>
                        </div>
                    </a>
                </div>
            </div>
                        ...
                        @if ($sub_sub_sub_cats)
                            @foreach ($sub_sub_sub_cats as $key => $sub_sub_sub_cat)
                                <tr>
                                    ...
                                    <td><img src="{{ asset('storage/' . $sub_sub_sub_cat->image) }}" alt=""
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body border br-7">
                                                        @php
                                                            $sub_sub_sub_cat = App\Models\Admin\SubSubSubCategory::where(
                                                                'slug',
                                                                $sub_sub_sub_cat->slug,
                                                            )->first();
                                                        @endphp
                                                        <form method="post"
                                                            ...
                                                            <div class="row mb-1">
                                                                ...
                                                                <div class="col-sm-8 text-start">
                                                                    <select name="sub_cat_id"
                                                                        class="form-control select" data-width="100%"
                                                                        data-minimum-results-for-search="Infinity">
                                                                        <option value=""> -- Select
                                                                            Category -- </option>
