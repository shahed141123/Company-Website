<div class="row">
    <div class="col-lg-6 offset-lg-3">
        <h5 class="mb-0 text-center" style="color: #247297;">All Navbar List</h5>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="mb-1">
                                                                        <label class="form-label"
                                                                            for="basicpill-firstname-input">Module
                                                                            Name</label>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <select name="type"
                                                                            ...
                                                                            data-placeholder="Chose Module Type"
                                                                            required>
                                                                            <option></option>
                                                                            <option @selected($item->type == 'column')
                                                                                value="column">Column</option>
                                                                            <option @selected($item->type == 'content')
                                                                                value="content">Content</option>
                                                                            <option @selected($item->type == 'double_column')
                                                                                value="double_column">Double Column
                                                                            </option>
                                                                            <option @selected($item->type == 'content_with_column')
                                                                                value="content_with_column">Content With
                                                                                Column</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
