<div class="row">
    ...
    <div class="col-lg-6 offset-lg-3">
        <h5 class="mb-0 text-center" style="color: #247297;">All Navbar Menu List</h5>
        <div class="card">
                                                                ...
                                                                <div class="container p-2 mx-2">
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <div class="mb-1">
                                                                                <label class="form-label"
                                                                                    for="basicpill-email-input">Module
                                                                                    Name</label>
                                                                                <select name="frontend_navbar_module_id"
                                                                                    class="form-control select"
                                                                                    data-minimum-results-for-search="Infinity"
                                                                                    data-placeholder="Chose Module Name"
                                                                                    required>
                                                                                    <option></option>
                                                                                    @foreach ($modules as $module)
                                                                                        <option
                                                                                            @selected($item->frontend_navbar_module_id == $module->id)
                                                                                            value="{{ $module->id }}">
                                                                                            {{ $module->name }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="mb-1">
                                                                                <label class="form-label"
                                                                                    for="basicpill-firstname-input">Menu
                                                                                    Name</label>
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="mb-1">
                                                                                <label class="form-label"
                                                                                    for="basicpill-firstname-input">Short
                                                                                    Description</label>
                                                                                <textarea class="form-control" name="short_description" rows="1" placeholder="Enter Short Description">{{ $item->short_description }}</textarea>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-6">
                                                                            <div class="mb-1">
