                ...
                <div class="row mt-3 gx-2 ">
                                        ...
                                        <tbody class="tb rounded-0 shadow">
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%"><input class="multiplyValue form-control form-control-sm"
                                                        type="text" value="{{ $sourcing->bank_charge }}"
                                                        name="bank_charge"></td>
                            ...
                            <div class="col-lg-6 mt-2">
                                ...
                                <div class="card rounded-0 mt-2" style="margin-top: -2px !important;">
                                    <div class="card-header p-1 rounded-0" style="background: #d3aebb;">
                                        <h6 class="mb-0 text-start" style="color: #580f29; font-size: 13px;">Sourcing
                                            Details
                                        </h6>
                                    </div>
                    ...
                    <div class="col-lg-4 col-sm-12">
                        ...
                        <div class="">
                            ...
                            <div class="card center bg-yellow py-2">
                                <div class="card-body p-1">

                                    <div class="text-center">
                                        <label for="approve-warning">
                                            <input type="checkbox" id="approve-warning" class="mr-2">
                                            Please Check the SAS Carefully and Give Approval.
                                        </label>

                                    </div>
                                    <div class="text-center approve_btn d-none mt-1">
                                        <button data-tip="Quick View" data-bs-toggle="modal" data-bs-target="#productReject"
                                            class="btn btn-info text-white">Reject</button>
                                        <button type="submit" class="btn btn-success ms-2" id="submitbtn">
                                            Approve SAS<i class="ph-paper-plane-tilt ms-2"></i></button>
                                    </div>
                                </div>
...
@once
    @push('scripts')
        <script type="text/javascript">
            ...
            $("#approve-warning").on('change', function() {
