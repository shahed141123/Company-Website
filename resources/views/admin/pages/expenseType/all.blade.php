                        ...
                        @if ($expenseTypes)
                            @foreach ($expenseTypes as $key => $expenseType)
                                <tr>
                                    ...
                                    {{-- <td>No Comments</td> --}}
                                    <td class="text-center"><span class=" text-success">{{ $expenseType->note }}</span>
                                    </td>
                                    <td>
                                        <a href="#" class="text-primary" data-bs-toggle="modal"
                                            ...
                                            {{-- Edit Expense Modal --}}
                                            <div id="tax_vat_edit_{{ $expenseType->id }}" class="modal fade" tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h6 class="modal-title text-white">Edit Expense Type</h6>
                                                            ...
                                                            <form
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12 d-flex pt-1">
                                                                        ...
                                                                        <input name="notes"
                                                                            value="{{ $expenseType->notes }}" type="text"
                                                                            maxlength="50"
                                                                            class="form-control form-control-sm"
