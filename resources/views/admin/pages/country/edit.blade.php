        ...
        <div class="content">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-7">
                            <h5 class="text-center">Country edit</h5>
                        </div>

                        <div class="col-lg-3"></div>
                        <div class="col-lg-2">
                            <a href="{{ route('country.index') }}" type="button"
                        ...
                        <div class="col-lg-6">
                            <div id="table1" class="card cardTd">
                                <div class="card-header">
                                    ...
                                    <h5 class="mb-0 text-center">Add Country Form</h5>
                                    ...
                                    <form method="post" action="{{ route('country.update', $country->id) }}">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="text" value="{{ $country->region_name }}" name="region_name"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="text" value="{{ $country->country_name }}"
                                                    name="country_name" class="form-control maxlength" maxlength="100" />
                                            </div>
                                        </div>
