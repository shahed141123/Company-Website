...
@section('content')
    ...
    <div class="content-wrapper">
            ...
            <div class="page-header-content d-lg-flex border-top">
                <div class="d-flex">
                    <div class="breadcrumb py-2">
                        ...
                        <a href="{{ route('event-category.index') }}" class="breadcrumb-item">Event Category</a>
                    </div>
        ...
        <div class="content pt-0 w-75 mx-auto">
            ...
            <div class="d-flex justify-content-start align-items-center py-2">
                <a href="" class=" text-success nav-link cat-tab3" data-bs-toggle="modal"
                    data-bs-target="#eventCategoryAdd">
            ...
            <div>
                <!-- Title Area End -->
                <table class="table eventCategoryDT table-bordered table-hover datatable-highlight text-center ">
                    <thead>
                        <tr>
                            <th width="5%">Id</th>
                            <th width="85%">Name</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="text-primary" data-bs-toggle="modal"
                                            data-bs-target="#eventCategory_{{ $eventCategory->id }}">
                                            <i class="fa-solid fa-pen-to-square me-2 p-1 rounded-circle text-white"
                                                style="color: #247297 !important;"></i>
                                            {{-- Edit event Category --}}
                                            <div id="eventCategory_{{ $eventCategory->id }}" class="modal fade"
                                                tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h6 class="modal-title text-white">Edit Event Category</h6>
                                                        ...
                                                        <div class="modal-body p-0 px-2">
                                                            <form
                                                                action="{{ route('event-category.update', $eventCategory->id) }}"
                                        ...
                                        <a href="{{ route('event-category.destroy', $eventCategory->id) }}"
        ...
        <!-- Basic modal -->
        <div id="eventCategoryAdd" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title text-white">Add Event Category</h6>
                        <a type="button" data-bs-dismiss="modal">
