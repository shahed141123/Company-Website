        ...
        <div class="content">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-7">
                            <h5 class="text-center">Add Account Profit Loss Form</h5>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div id="table1" class="card cardTd">
                                <div class="card-body">
                                    <form method="post" action="{{ route('account-profit-loss.store') }}">
                                        @csrf
                                        <div class="row mb-3">
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="text" name="sales_price" class="form-control maxlength"
                                                    maxlength="30" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="text" name="cost_price" class="form-control maxlength"
                                                    maxlength="30" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="text" name="gross_makup_ammount"
                                                    class="form-control maxlength" maxlength="30" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="text" name="net_profit_ammount"
                                                    class="form-control maxlength" maxlength="30" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="text" name="profit" class="form-control maxlength"
                                                    maxlength="30" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="text" name="loss" class="form-control maxlength"
                                                    maxlength="30" />
                                            </div>
                                        </div>
                                        <div class="row">
