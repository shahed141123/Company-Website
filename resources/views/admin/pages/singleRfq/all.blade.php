                            ...
                            <ul class="nav nav-tabs flex-column border-0" id="myTabs" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="tab3-tab" data-bs-toggle="tab" data-bs-target="#tab3"
                                        ...
                                        aria-selected="false" tabindex="-1">Bypass</button>
                                </li>
                                <li class="nav-item" role="presentation">
                ...
                <div class="col-lg-12">
                    <div class="tab-content bg-white mt-0 pt-0" id="myTabContent">
                                    ...
                                    <div class="row rounded">
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="client_details">
                                                {{-- Save Table --}}
                                                <table
                                                    class="table sourcingDT border table-bordered table-hover text-center">
                                                    <thead>
                                                        <tr>
                                                ...
                                                <div class="table-responsive text-center">
                                                    ...
                                                    @if (!empty($sourcing->grand_total))
                                                        <table class="table table-bordered"
                                                            ...
                                                            <thead>
                                                                <tr class="expand-switch1" style="padding-top: 8px;padding-bottom: 8px; background-color: #247297 !important;">
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            <div class="card rounded-0">
                                <div class="card-header rounded-0 p-1" style="background-color: #247297;">
                                    <h4 class="m-0 p-0 text-center text-white">Actions</h4>
                                </div>
                                <div class="card-body p-0">
                        ...
                        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                            <div class="card rounded-0">
                                <div class="card-header rounded-0 p-1" style="background-color: #247297;">
                                    <h4 class="m-0 p-0 text-center text-white">Bypass</h4>
                                </div>
                                <div class="card-body p-0">
                                    asdasdasdasdasdasd
                                </div>
