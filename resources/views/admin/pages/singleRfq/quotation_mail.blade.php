    ...
    <section class="container" style="margin-top: 0.5rem; margin-bottom: 0.5rem">
        <div
            ...
            <div class="wrapper">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div style="padding-top: 20px;padding-bottom: 20px;padding-left: 0;">
                                            <h3 style="font-size: 18px;font-family: 'Poppins', sans-serif;color: #ae0a46;">
                                            ...
                                            <div style="padding-top: 20px">
                                                <p style="padding-bottom: 5px; font-size: 14px">
                                    ...
                                    <div style="text-align: end">
                                        <div>
                                            ...
                                            <div>
                                                <p
                                                    style="color: #000;padding-bottom: 5px;font-size: 14px; display: flex;align-items: center;">
                                                    Date : <input class="w-lg-200px w-100 form-control form-control-sm"
                                                        type="text" name="date" value="01 January 2024 "
                                                        placeholder="Date">
                                                </p>
                                                <p style="color: #000;padding-bottom: 5px;font-size: 14px;">
                ...
                <!-- Main Content Start -->
                <div
                    style="overflow-x: auto;padding-left: 30px;padding-right: 30px;padding-top: 15px;padding-bottom: 15px;">
                    <table style="border-collapse: collapse;width: 100%;border: 1px solid #eee;">
                        <!-- Table Header Start -->
                        <tr style="background-color: #e5e5e5;color: #000;border: 1px solid #eee;font-size: 14px;">
                            <th style="text-align: center; padding: 8px; font-weight: 400;">Sl</th>
                            ...
                            <table>
                                <tbody class="text-center">
                                    <tr>
                                        ...
                                        <td width="25%">
                                            <div>
                                                ...
                                                <input type="radio" id="css" name="validity"
                                                    value="hide">
                                    ...
                                    <tr>
                                        ...
                                        <td width="25%">
                                            <div>
                                                ...
                                                <label for="html">Show</label><br>
                                                <input type="radio" id="css" name="payment"
                                                    value="hide">
                                                <label for="css">Hide</label><br>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="25%">
                                            <div>
                                                <input type="radio" id="html" name="payment_mode" value="HTML">
                                                <label for="html">Show</label><br>
                                    ...
                                    <tr>
                                        ...
                                        <td width="25%">
                                            <div>
                                                ...
                                                <label for="html">Show</label><br>
                                                <input type="radio" id="css" name="delivery"
                                                    value="hide">
                                                <label for="css">Hide</label><br>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="25%">
                                            <div>
                                                <input type="radio" id="html" name="delivery_location" value="HTML">
                                                <label for="html">Show</label><br>
                                    ...
                                    <tr>
                                        ...
                                        <td width="25%">
                                            <div>
                                                <input type="radio" id="html" name="product_order" value="HTML">
                                                <label for="html">Show</label><br>
                                    ...
                                    <tr>
                                        ...
                                        <td width="25%">
                                            <div>
                                                <input type="radio" id="html" name="installation_support" value="HTML">
                                                <label for="html">Show</label><br>
                                    ...
                                    <tr>
                                        ...
                                        <td width="25%">
                                            <div>
                                                <input type="radio" id="html" name="pmt_condition" value="HTML">
                                                <label for="html">Show</label><br>
