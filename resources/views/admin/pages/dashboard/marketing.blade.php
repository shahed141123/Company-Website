            ...
            <div class="container-fluid ">
                <div class="row">
                    <h1 class="mb-0 text-center w-25 mx-auto mb-2 text-info"
                        style="color: #247297; border-bottom: 1px solid #247297;">Marketing Dashboard</h1>
                </div>
                {{-- Extra Area --}}
                <div class="row">
                    <div class="col-lg-4">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 bg-light px-1 py-1 rounded">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <a href="{{ route('cmar.index') }}">
                                                Marketing CMAR
                                            </a>
                                            <a href="{{ route('cmar.create') }}"><span
                                    ...
                                    <div class="col-sm-12 bg-light px-1 py-1 rounded mt-1">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <a href="{{ route('marketing-dmar.index') }}">
                                                Marketing DMAR
                                            </a>
                                            <a href="{{ route('marketing-dmar.create') }}"><span
                                                    class="rounded-circle border border-secondary text-center">
                                                    <i class="fa fa-plus text-secondary"></i>
                                                </span></a>
                                        </div>
