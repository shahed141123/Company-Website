                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="px-2 bg-light p-2">
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <select data-allow-clear="true" name="brand_id" data-placeholder="Select row_four.."
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-12 col-sm-12">
                                            <input type="text" name="row_one_title"
                                                ...
                                                id="title" placeholder="Row One Title"  value="{{ $brandPage->row_one_title }}" />
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="row mb-1">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="px-2 bg-light p-2">
                                    ...
                                    <div class="row mb-1 gx-0">
                                        ...
                                        <div class="col-sm-11 text-secondary">
                                            <input type="file" name="row_six_image" class="form-control form-control-sm"
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-12 col-sm-12">
                                            <input type="text" name="row_six_title" class="form-control form-control-sm maxlength"
                                                maxlength="255" id="title" placeholder="Row Six Title" value="{{ $brandPage->row_six_title }}" />
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-12 col-sm-12">
                                            <textarea name="row_six_header" id="" class="form-control" cols="30" rows="2" placeholder="Row Six header"
                                ...
                                <p class="text-center text-secondary pb-0 mb-0" style="border-bottom: 1px solid #247297;"> Row Nine</p>
                                <div class="px-2 bg-light p-2">
                                    <div class="row mb-1">
                                        <div class="col-lg-12 col-sm-12">
                                        ...
                                        <div class="col-lg-12 col-sm-12">
                                            <input type="text" name="row_nine_title"
                                                class="form-control form-control-sm maxlength" maxlength="255"
                                                id="title" placeholder="Row One Title"  value="{{ $brandPage->row_nine_title }}"/>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-12 col-sm-12">
                                            <textarea name="row_nine_header" id="" class="form-control" cols="30" rows="2" placeholder="Row Six header"
                                                >{{ $brandPage->row_nine_header }}</textarea>
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
