        ...
        <div class="content pt-0 w-50 mx-auto mt-2">
            <div class="d-flex align-items-center py-1 bg-white">
                ...
                <div class="text-success nav-link cat-tab3">
                    <a href="{{ route('software-info-page.create') }}" data-bs-toggle="tooltip"
                    ...
                    <div class="text-center" style="margin-left: 4.5rem;">
                        <h5 class="ms-1 mb-0" style="color: #247297;">Software Info Page</h5>
                    </div>
                </div>
                {{-- Add Details End --}}
            </div>
