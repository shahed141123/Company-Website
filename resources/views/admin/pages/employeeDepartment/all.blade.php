...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content pt-0 w-75 mx-auto">
            ...
            <div>
                <!-- Title Area End -->
                <table class="table employeeDepartmentDT table-bordered table-hover datatable-highlight text-center ">
                    <thead>
                        <tr>
                            <th width="5%">Id</th>
                            <th width="85%">Name</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="text-primary" data-bs-toggle="modal"
                                            ...
                                            <div id="employeeDepartment_{{ $employeeDepartment->id }}" class="modal fade"
                                                tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h6 class="modal-title text-white">Edit Employee Department</h6>
