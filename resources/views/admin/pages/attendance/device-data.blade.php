        ...
        <div class="container">
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                ...
                <div class="ml-12">
                    ...
                    <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laracasts.com"
                            class="underline text-gray-900 dark:text-white">Device data</a></div>
                </div> --}}
            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-1">
                    ...
                    <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laracasts.com"
                            class="underline text-gray-900 dark:text-white">All data from device : <b>Users</b></a></div>
                </div>
                <hr /> --}}
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($users as $user)
                                            <tr>
                                                ...
                                                <td>{{ $user['cardno'] }}</td>
                                                <td>
                                                    {{-- <a class="btn btn-success btn-sm" href="3">
                                                        View</a>
                                                    <a class="btn btn-success btn-sm" href="#">
                                                        Delete</a> --}}
                                                    <a class="btn btn-success btn-sm"
                                                        href="{{ route('machine.deviceviewusersingle', $user) }}">
                                                        View</a>
                                                    <a class="btn btn-success btn-sm"
            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-1">
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class=" ">
                            <a href="#" class="btn btn-success " style="float:right;margin-left: 5px">Clear
                                attendance</a>
                            <a href="#" class="btn btn-success" style="float:right">
                                Reload
                            </a>
                            {{-- <a href="{{ route('machine.devicedata.clear.attendance') }}" class="btn btn-success "
                        style="float:right;margin-left: 5px">Clear attendance</a>
                    <a href="{{ route('machine.devicedata') }}" class="btn btn-success" style="float:right">
                        Reload
                    </a> --}}
                        </div>
                    ...
                    <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laracasts.com"
                            class="underline text-gray-900 dark:text-white">All data from device : <b>Attendance</b></a>
                    </div>
                </div> --}}
                        <hr />
                        <div class="ml-12">
