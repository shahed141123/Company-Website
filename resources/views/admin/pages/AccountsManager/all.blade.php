    ...
    <div class="content-wrapper">
        ...
        <div class="page-header page-header-light shadow">
            <div class="page-header-content d-lg-flex justify-content-between align-items-center border-top">
                ...
                <div>
                    <a href="{{ route('accounts-manager.create') }}" class="btn navigation_btn" style="width: 100px">
                        <div class="d-flex align-items-center">
                            <i class="ph-plus icons_design me-1" style="font-size: 10px;"></i>
                            <span>Add</span>
                        </div>
                    </a>
                </div>
        ...
        <div class="content">
            <div class="row">
                <h5 class="text-center">All Accounts Managers</h5>
                <div class="col-lg-12">
                                                                            ...
                                                                            <form method="post"
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="card">
                                                                                        ...
                                                                                        <div
                                                                                            class="row mt-2 p-2 text-center">
