    ...
    <div class="content-wrapper">
                ...
                <div class="d-flex">
                    <div>
                        ...
                        <a href="javascript:void()" class="btn navigation_btn">
                            <div class="d-flex align-items-center " data-bs-toggle="modal" data-bs-target="#modal_expense">
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="d-flex align-items-center justify-content-center" style="border-bottom: 1px solid #247297;">
                    <ul class="nav nav-tabs border-0" role="tablist">
                        <li class="nav-item mb-0" role="presentation">
                            <a href="#js-All-Expense-tab" class="nav-link active" data-bs-toggle="tab"
                                aria-selected="true" role="tab" tabindex="-1">
                                All Expense
                            </a>
                        </li>
                        <li class="nav-item mb-0" role="presentation">
                            <a href="#js-January-tab" class="nav-link" data-bs-toggle="tab" aria-selected="true"
                                role="tab" tabindex="-1">
                                Jan
                            </a>
                        </li>
                    ...
                    <div class="tab-pane fade active show" id="js-All-Expense-tab" role="tabpanel">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-0">
                                <table class="table whatWeDoDt table-striped table-bordered table-hover text-center">
                                    <thead>
                                        <tr class="text-small">
