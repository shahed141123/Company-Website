                ...
                <div class="d-flex align-items-center justify-content-start main_bg py-1">
                    <div class="ms-2">
                        <a class="btn btn-primary btn-rounded rounded-circle btn-icon back-btn"
                            href="{{ route('hardware-info-page.index') }}">
                            <i class="fa-solid fa-arrow-left main_color"></i>
                        </a>
                    </div>
                    <div class="me-2" style="margin-left: 23rem;">
                        <p class="text-white p-0 m-0 fw-bold"> Edit Hardware Info Page Form</p>
                    </div>
                </div>
            </div>
            <form method="post" action="{{ route('hardware-info-page.update', $hardwareInfoPage->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <!--Banner Section-->
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="banner_image" type="file" class="form-control form-control-sm w-75"
                                                placeholder="Enter Hardware Banner Image" value="{{ $hardwareInfoPage->banner_image }}">
                                            <img class="px-1" id="showImage" height="30px" width="50px"
                                                src="{{asset('storage/requestImg/'.$hardwareInfoPage->banner_image)}}" alt="">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="banner_title" maxlength="255" type="text"
                                                ...
                                                placeholder="Enter Hardware Banner Title" value="{{ $hardwareInfoPage->banner_title }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="banner_short_description" type="text"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Banner Short Description" value="{{ $hardwareInfoPage->banner_short_description }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="banner_btn_name" type="text" maxlength="255"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Banner Btn Name" value="{{ $hardwareInfoPage->banner_btn_name }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="banner_btn_link" type="text" maxlength="100"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Banner Btn Name" value="{{ $hardwareInfoPage->banner_btn_link }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_two_title" maxlength="100" type="text"
                                                ...
                                                value="{{ $hardwareInfoPage->row_two_title }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_two_short_description" type="text"
                                                class="form-control form-control-sm" placeholder="Enter Hardware Card Title"
                                                value="{{ $hardwareInfoPage->row_two_short_description }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_four_title" type="text" maxlength="255"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Row Four Title " value="{{ $hardwareInfoPage->row_four_title }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_four_short_description" type="text"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Row Four Short Description " value="{{ $hardwareInfoPage->row_four_short_description }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_four_video_link" type="text" maxlength="100"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Row Four Video Link" value="{{ $hardwareInfoPage->row_four_video_link }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_four_btn_name" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Row Four Btn Name" value="{{ $hardwareInfoPage->row_four_btn_name }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_four_sub_title" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Row Four Sub Title" value="{{ $hardwareInfoPage->row_four_sub_title }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_four_btn_link" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Row Four Btn Link" value="{{ $hardwareInfoPage->row_four_btn_link }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_seven_title" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Row Seven Title" value="{{ $hardwareInfoPage->row_seven_title }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_five_title" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Five Title" value="{{ $hardwareInfoPage->row_five_title }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_five_short_description" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Five Short Description" value="{{ $hardwareInfoPage->row_five_short_description }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_six_title" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Row Six Title" value="{{ $hardwareInfoPage->row_six_title }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_six_short_description" type="text"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Row Six Short Description" value="{{ $hardwareInfoPage->row_six_short_description }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_six_btn_name" type="text"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Row Six Btn Name" value="{{ $hardwareInfoPage->row_six_btn_name }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_six_btn_link" type="text"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Row Six Btn Link" value="{{ $hardwareInfoPage->row_six_btn_link }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_six_image" type="file"
                                                ...
                                                placeholder="Enter Hardware Row Six Image" value="{{ $hardwareInfoPage->row_six_image }}">
                                            <img class="px-1" id="showImage" height="30px" width="50px"
                                                src="{{asset('storage/requestImg/'.$hardwareInfoPage->row_six_image)}}" alt="">
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_eight_title" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Row Eight Title " value="{{ $hardwareInfoPage->row_eight_title }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_eight_short_description" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Row Eight Short Description" value="{{ $hardwareInfoPage->row_eight_short_description }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
