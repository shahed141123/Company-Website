                                ...
                                <div class="px-2 py-2 rounded bg-light mt-2">
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <input type="text" name="name" value="{{ $job->name }}" class="form-control form-control-sm"
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <input type="text" name="vacancy" value="{{ $job->vacancy }}" class="form-control form-control-sm"
                                                maxlength="255" required />
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <input type="text" name="deadline" value="{{ $job->deadline }}" class="form-control form-control-sm"
                                                maxlength="255" required />
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <input type="text" name="link" value="{{ $job->link }}" class="form-control form-control-sm"
                                                maxlength="255" required />
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <input type="text" name="company_name" value="{{ $job->company_name }}" class="form-control form-control-sm"
                                                maxlength="255" required />
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <input type="text" name="category" value="{{ $job->category }}" class="form-control form-control-sm"
                                                maxlength="255" required />
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <input type="text" name="experience" value="{{ $job->experience }}" class="form-control form-control-sm"
                                                maxlength="255" required />
                                        </div>
                                    </div>
                                    {{--  --}}
