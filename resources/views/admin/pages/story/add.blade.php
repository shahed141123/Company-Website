            ...
            <div class="page-header-content d-flex justify-content-between align-items-center border-top">
                <div class="d-flex">
                    <div class="breadcrumb py-2">
                        ...
                        <a href="{{ route('clientstory.index') }}" class="breadcrumb-item">Client Story Management</a>
                        ...
                        <div class="col-lg-12 col-sm-12 d-flex justify-content-between align-items-center px-2">
                            <div class="">
                                <a class="btn btn-primary btn-rounded rounded-circle btn-icon back-btn"
                                    href="{{ route('clientstory.index') }}">
                                    <i class="fa-solid fa-arrow-left main_color"></i>
                                </a>
                            </div>
                            <p class="text-white p-0 m-0 fw-bold"> Add Client Story </p>
                        </div>
                    </div>
                    <form id="myform" method="post" action="{{ route('clientstory.store') }}"
                                            ...
                                            <div class="d-flex align-items-center pt-1">
                                                ...
                                                <div class="input-group">
                                                    <input name="badge" maxlength="255" type="text"
                                                        ...
                                                        placeholder="Enter Author Badge" required>
                                                </div>
                                            </div>
                                            {{--  --}}
                                            ...
                                            <div class="d-flex align-items-center pt-1">
                                                ...
                                                <div class="input-group">
                                                    <input name="title" maxlength="255" type="text"
                                                        class="form-control form-control-sm"
                                                        placeholder="Enter Box One Title" required>
                                                </div>
                                            </div>
                                            {{--  --}}
                                            <div class="d-flex align-items-center pt-1">
