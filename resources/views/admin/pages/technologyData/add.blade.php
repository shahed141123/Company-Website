        ...
        <div class="content">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-7">
                            <h5 class="text-center">Add Technology Data Form</h5>
                        </div>
                                    ...
                                    <form method="post" action="{{ route('technology-data.store') }}">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="text" name="header" class="form-control maxlength"
                                                    maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-8 text-secondary">
                                                <input type="text" name="footer" class="form-control maxlength"
                                                    maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="row">
