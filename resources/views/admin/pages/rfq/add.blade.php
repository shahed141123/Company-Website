                            ...
                            <form method="post" action="{{ route('deal.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="accordion padding" id="accordion_expanded">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="client_details" class="accordion-collapse collapse" data-bs-parent="#accordion_expanded">
                                            <div class="accordion-body">
                                                        ...
                                                        <div class="form-group text-secondary col-sm-8 basic-form">
                                                            <select name="client_id" class="form-control select clientID"
                                                                ...
                                                                @foreach ($clients as $client)
                                                                    <option value="{{ $client->id }}">Name : {{ $client->name }}; Company Name : {{ $client->company_name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group text-secondary col-sm-8">
                                                            <select name="partner_id" class="form-control select partnerID"
                                                                ...
                                                                @foreach ($partners as $partner)
                                                                    <option value="{{ $partner->id }}">Name : {{ $partner->name }}; Company Name : {{ $partner->company_name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="center mb-3 bg-gray p-1 text-center">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="1" name="regular" id="flexRadioDefault1">
                                                        <label class="form-check-label" for="flexRadioDefault1">
                                                            Regular Discount
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="1" name="special" id="flexRadioDefault1">
                                                        <label class="form-check-label" for="flexRadioDefault1">
                                                            Special Discount
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="1" name="tax_status" id="flexRadioDefault1">
                                                        <label class="form-check-label" for="flexRadioDefault1">
                                                            Tax / VAT
                                                        </label>
                                                    </div>
