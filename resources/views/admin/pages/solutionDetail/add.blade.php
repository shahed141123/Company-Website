                            ...
                            <div class="col mt-0">
                                ...
                                <div class="d-flex align-items-center pt-1">
                                    <label
                                        ...
                                        Header</label>
                                    <div class="input-group">
                                        <textarea class="form-control form-control-sm" name="header" rows="2"
                        ...
                        <div class="row g-2 p-1">
                            <div class="col">
                                ...
                                <div class="px-2 py-2 rounded bg-light">
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        <label class="col-form-label label_style col-lg-2 p-0 text-start text-black">Row With List
                                            ID</label>
                                ...
                                <div class="px-2 py-2 rounded bg-light mt-2">
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control" name="row_two_header" rows="4"
                                ...
                                <div class="px-2 py-2 rounded bg-light">
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <select name="row_four_id" class="form-control form-select-sm select"
                                            data-container-css-class="select-sm"
                                            data-placeholder="Chose Row Four With Image" required>
                                            <option></option>
                                            @foreach ($rows as $row)
                                                <option class="form-control" value="{{ $row->id }}">
                                                    {{ $row->title }}</option>
