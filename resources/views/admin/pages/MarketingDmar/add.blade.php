                ...
                <div class="text-start">
                    <div class="row main_bg py-1 rounded-1 d-flex align-items-center gx-0 px-2">
                        ...
                        <div class="col-lg-4 col-sm-12 d-flex justify-content-center">
                            <p class="text-white p-0 m-0 fw-bold"> Add Marketing Dmar Form</p>
                        </div>
                                    ...
                                    <div class="row mb-1 d-flex align-items-center">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <input type="text" name="area" class="form-control form-control-sm"
                                                maxlength="100" placeholder="Inter Area" required />
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="row mb-1 d-flex align-items-center">
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <input type="text" name="company_name"
                                                class="form-control form-control-sm maxlength" placeholder="Enter Company Name" maxlength="100" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <input type="text" name="product"
                                                class="form-control form-control-sm maxlength" placeholder="Enter Product" maxlength="100" required />
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <input type="number" name="phone"
                                                class="form-control form-control-sm maxlength" placeholder="Enter Phone" maxlength="100" required />
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <input type="number" name="contact"
                                                class="form-control form-control-sm maxlength" placeholder="Enter Contact" maxlength="100" required />
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <input type="number" name="comments_by_sales"
                                                class="form-control form-control-sm maxlength" placeholder="Enter Comments By Sales" maxlength="100" required />
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <input type="number" name="comments_by_ceo"
                                                class="form-control form-control-sm maxlength" placeholder="Enter Comments By Ceo" maxlength="100" required />
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <input type="number" name="action_on_fail"
                                                class="form-control form-control-sm maxlength" placeholder="Enter Action On Fail" maxlength="100" required />
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
