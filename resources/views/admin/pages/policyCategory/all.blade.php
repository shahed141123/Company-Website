    ...
    <div class="content-wrapper">
            ...
            <div class="page-header-content d-lg-flex border-top">
                <div class="d-flex">
                    <div class="breadcrumb py-2">
                        ...
                        <a href="{{ route('policy-category.index') }}" class="breadcrumb-item">Policy Category</a>
                    </div>
        ...
        <div class="content pt-0 w-75 mx-auto">
            ...
            <div class="d-flex justify-content-start align-items-center py-2">
                <a href="" class=" text-success nav-link cat-tab3" data-bs-toggle="modal"
                    data-bs-target="#policyCategoryAdd">
            ...
            <div>
                <!-- Title Area End -->
                <table class="table policyCategoryDT table-bordered table-hover datatable-highlight text-center ">
                    <thead>
                        <tr>
                            <th width="5%">Id</th>
                            <th width="85%">Name</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="text-primary" data-bs-toggle="modal"
                                            data-bs-target="#policyCategory_{{ $policyCategory->id }}">
                                            <i class="fa-solid fa-pen-to-square me-2 p-1 rounded-circle text-white"
                                                style="color: #247297 !important;"></i>
                                            {{-- Edit Policy Category --}}
                                            <div id="policyCategory_{{ $policyCategory->id }}" class="modal fade"
                                                tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h6 class="modal-title text-white">Edit Policy Category</h6>
                                                        ...
                                                        <div class="modal-body p-0 px-2">
                                                            <form
                                                                action="{{ route('policy-category.update', $policyCategory->id) }}"
                                        ...
                                        <a href="{{ route('policy-category.destroy', $policyCategory->id) }}"
        ...
        <div id="policyCategoryAdd" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title text-white">Add Policy Category</h6>
                        <a type="button" data-bs-dismiss="modal">
                            <i class="ph ph-x text-white" style="font-weight: 800;font-size: 10px;"></i>
                        </a>
                    </div>
                    <div class="modal-body p-0 px-2">
                        <form action="{{ route('policy-category.store') }}" method="post"
