                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="input-group">
                                                                <input name="title" type="text"
                                                                    class="form-control form-control-sm"
                                                                    placeholder="Enter Image With Row Title" value="{{ $row->title }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="d-flex align-items-center pt-1">
                                                                ...
                                                                <div class="input-group">
                                                                    <input name="image" id="image" accept="image/*"
                                                                        type="file" class="form-control form-control-sm" placeholder="Enter Row Image">
                                                                    <div class="form-text">Accepts only png, jpg, jpeg images</div>
                                                                    <img id="showImage" height="100px" width="100px"
                                                                        src="{{asset('storage/requestImg/'.$row->image)}}" alt="">
                                                                </div>
                                                            </div>
                                                            {{--  --}}
                                                            <div class="d-flex align-items-center pt-1">
                                                                ...
                                                                <div class="input-group">
                                                                    <input name="btn_name" type="text" maxlength="250"
                                                                        class="form-control form-control-sm"
                                                                        placeholder="Enter Row Button Name" value="{{$row->btn_name}}">
                                                                </div>
                                                            </div>
                                                            {{--  --}}
                                                            <div class="d-flex align-items-center pt-1">
                                                                ...
                                                                <div class="input-group">
                                                                    <input name="link" type="url" maxlength="250"
                                                                        class="form-control form-control-sm"
                                                                        placeholder="Enter Row Button Link" value="{{$row->link}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="d-flex align-items-center pt-1">
                                                            ...
                                                            <div class="input-group">
                                                                <input name="list_title" type="text" maxlength="250"
                                                                    class="form-control form-control-sm"
                                                                    placeholder="Enter List Title" value="{{ $row->list_title }}">
                                                            </div>
                                                        </div>
                                                        {{--  --}}
                                                        <div class="d-flex align-items-center pt-1">
                                                            ...
                                                            <div class="input-group">
                                                                <input name="list_one" type="text" maxlength="250"
                                                                    class="form-control form-control-sm"
                                                                    placeholder="Enter List Title One" value="{{ $row->list_one }}">
                                                            </div>
                                                        </div>
                                                        {{--  --}}
                                                        <div class="d-flex align-items-center pt-1">
                                                            ...
                                                            <div class="input-group">
                                                                <input name="list_two" type="text" maxlength="250"
                                                                    class="form-control form-control-sm"
                                                                    placeholder="Enter List Title Two" value="{{ $row->list_two }}">
                                                            </div>
                                                        </div>
                                                        {{--  --}}
                                                        <div class="d-flex align-items-center pt-1">
                                                            ...
                                                            <div class="input-group">
                                                                <input name="list_three" type="text" maxlength="250"
                                                                    class="form-control form-control-sm"
                                                                    placeholder="Enter List Title Three" value="{{ $row->list_three }}">
                                                            </div>
                                                        </div>
                                                        {{--  --}}
                                                        <div class="d-flex align-items-center pt-1">
                                                            ...
                                                            <div class="input-group">
                                                                <input name="list_four" type="text" maxlength="250"
                                                                    class="form-control form-control-sm"
                                                                    placeholder="Enter List Title Four" value="{{ $row->list_four }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
