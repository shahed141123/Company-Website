    ...
    !(function () {
      ...
      function o(e, t, a) {
        var o = "",
          s = "";
        t - e < 100 || "Today" == a
          ? ((o = "Today:"), (s = e.format("MMM D")))
          : "Yesterday" == a
            ? ((o = "Yesterday:"), (s = e.format("MMM D")))
            : (s = e.format("MMM D") + " - " + t.format("MMM D")),
          $("#kt_dashboard_daterangepicker_date").html(s),
      ...
      a &&
        new ApexCharts(a, {
          ...
          plotOptions: {
            bar: { horizontal: !1, columnWidth: ["30%"], borderRadius: 4 },
          },
          legend: { show: !1 },
          dataLabels: { enabled: !1 },
      ...
      (function () {
        ...
        e &&
          new ApexCharts(e, {
            series: [
              { name: "Net Profit", data: [30, 40, 40, 90, 90, 70, 70] },
            ],
            chart: {
              fontFamily: "inherit",
              type: "area",
        ...
        [].slice.call(o).map(function (o) {
          (a = parseInt(KTUtil.css(o, "height"))),
            (e = KTUtil.getCssVariableValue(
              "--bs-" + o.getAttribute("data-kt-color"),
            )),
            (t = KTUtil.colorDarken(e, 15)),
            new ApexCharts(o, {
              series: [
                { name: "Net Profit", data: [30, 45, 32, 70, 40, 40, 40] },
              ],
              chart: {
                fontFamily: "inherit",
                type: "area",
        ...
        [].slice.call(o).map(function (o) {
          (e = o.getAttribute("data-kt-color")),
            ...
            new ApexCharts(o, {
              ...
              plotOptions: {
                bar: { horizontal: !1, columnWidth: ["50%"], borderRadius: 4 },
              },
              legend: { show: !1 },
              dataLabels: { enabled: !1 },
              stroke: { show: !0, width: 2, colors: ["transparent"] },
        ...
        [].slice.call(t).map(function (t) {
          (e = parseInt(KTUtil.css(t, "height"))),
            new ApexCharts(t, {
              ...
              plotOptions: {
                bar: { horizontal: !1, columnWidth: ["30%"], borderRadius: 2 },
              },
              legend: { show: !1 },
              dataLabels: { enabled: !1 },
            ...
            series: [
              {
                name: "Inflation",
                data: [
                  1, 2.1, 1, 2.1, 4.1, 6.1, 4.1, 4.1, 2.1, 4.1, 2.1, 3.1, 1, 1,
                  2.1,
                ],
              },
            ],
      ...
      (function () {
        ...
        if (e) {
          ...
          new ApexCharts(e, {
            ...
            colors: [s],
            markers: { colors: [s], strokeColor: [o], strokeWidth: 3 },
          }).render();
        }
      })(),
      (function () {
      ...
      (n = document.querySelector("#kt_forms_widget_1_form")) &&
        ...
        new Quill("#kt_forms_widget_1_editor", {
          modules: {
            toolbar: { container: "#kt_forms_widget_1_editor_toolbar" },
          },
            ...
            h.classList.contains("btn-success")
              ...
              : setTimeout(function () {
                  h.removeAttribute("data-kt-indicator"),
                    ...
                    (h.querySelector(".indicator-label").innerHTML =
                      "Following"),
                    (h.disabled = !1);
                }, 1e3);
        }),
