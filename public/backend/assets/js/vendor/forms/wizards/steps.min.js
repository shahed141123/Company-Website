...
!(function (a, b) {
    ...
    function x(b, c, d, e, f) {
        ...
        return (
            (null == f.contentMode || f.contentMode === $.html) &&
                i.html(f.content),
            0 === e
                ...
                switch (r($, f.contentMode)) {
                    ...
                    case $.async:
                        var g = k(b, e)
                            ...
                            .empty()
                            .append(
                                M(c.loadingTemplate, { text: c.labels.loading })
                            );
                        a.ajax({ url: f.contentUrl, cache: !1 }).done(function (
                            a
                        ) {
                            g
                                .empty()
        ...
        if (b.enablePagination) {
            ...
            b.enableFinishButton && b.showFinishButtonAlways
                ? (d._enableAria(c.stepCount > 0),
                  e._enableAria(
                      c.stepCount > 1 && c.stepCount > c.currentIndex + 1
                  ))
                : (d._showAria(
                  ...
                  e
                      ._showAria(
                          0 === c.stepCount || c.stepCount > c.currentIndex + 1
                      )
                      ._enableAria(
                          c.stepCount > c.currentIndex + 1 ||
                              !b.enableFinishButton
                      ));
        }
    }
    function E(b, c, d, e) {
    ...
    function L(a, b, c) {
        if (b.enablePagination) {
            ...
            b.forceMoveForward ||
                ((e =
                    '<li><a href="#{0}" class="btn btn-light" role="menuitem">{1}</a></li>'),
                (f += e.format("previous", b.labels.previous))),
                (e =
                    '<li><a href="#{0}" class="btn btn-primary" role="menuitem">{1}</a></li>'),
                (f += e.format("next", b.labels.next)),
                b.enableFinishButton &&
                    ((e =
                        '<li><a href="#{0}" class="btn btn-primary" role="menuitem">{1}</a></li>'),
                    (f += e.format("finish", b.labels.finish))),
                b.enableCancelButton &&
                    ((e =
                        '<li><a href="#{0}" class="btn btn-light" role="menuitem">{1}</a></li>'),
                    (f += e.format("cancel", b.labels.cancel))),
                a.append(
                    d.format(
        ...
        n._enableAria(c.enableAllSteps || d.currentIndex > f),
            ...
            0 === f
                ...
                : l
                      ...
                      .after(n),
            0 === f &&
                l.find("li").removeClass("first").eq(f).addClass("first"),
            f === d.stepCount - 1 &&
